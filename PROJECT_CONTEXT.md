...
- Primera vista terminada: mapa 3D/2D, imagen Sentinel-2 y delimitaciones 2026, referencias BMCH/AWS-Mocho, métricas, fuentes y diseño móvil.
- Capítulo 2: navegación horizontal `#capitulo-1` / `#capitulo-2`, Figura 2 con pérdidas rojas, ganancias azules y descarga CSV sin tabla; Figura 4 con dos paneles interactivos, tabla y CSV; Figura 7 con el mismo mapa 3D/2D del capítulo 1 y las 12 delimitaciones de la serie publicada.
...
- Balizas: diez puntos nativos de MapLibre sobre el relieve, sin desplazamientos de marcadores HTML; la ficha consultable muestra solo nombre y coordenadas WGS84. B15 y la referencia AWS comparten coordenada.
...
- data/study-area.json, data/mass-balance-history.json, data/stakes.geojson, data/glacier-variations.json, data/icecap-history.geojson y data/satellite-2026.webp: derivados web activos. `satellite-2025.webp` se conserva como antecedente.
